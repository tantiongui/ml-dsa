package dut_types;
  ...
  typedef logic [99:0] array_of_8_logic_vector_100 [0:7];
  typedef logic [99:0] array_of_9_logic_vector_100 [0:8];
  ...
  typedef struct packed {
    ...
    logic [111:0] Tuple2_4_sel1;
  } Tuple2_4;
  typedef struct packed {
    logic [6:0] Tuple3_0_sel0;
    logic [111:0] Tuple3_0_sel1;
  ...
  function automatic logic [0:7][99:0] array_of_8_logic_vector_100_to_lv(array_of_8_logic_vector_100 i);
    for (int n = 0; n < 8; n=n+1)
      array_of_8_logic_vector_100_to_lv[n] = i[n];
  endfunction
  function automatic array_of_8_logic_vector_100 array_of_8_logic_vector_100_from_lv(logic [0:7][99:0] i);
    for (int n = 0; n < 8; n=n+1)
      array_of_8_logic_vector_100_from_lv[n] = i[n];
  endfunction
  function automatic array_of_8_logic_vector_100 array_of_8_logic_vector_100_cons(logic [99:0] x,logic [99:0] xs [0:6]);
    array_of_8_logic_vector_100_cons[0] = x;
    array_of_8_logic_vector_100_cons[1:7] = xs;
  endfunction
  function automatic logic [0:8][99:0] array_of_9_logic_vector_100_to_lv(array_of_9_logic_vector_100 i);
    for (int n = 0; n < 9; n=n+1)
      array_of_9_logic_vector_100_to_lv[n] = i[n];
  endfunction
  function automatic array_of_9_logic_vector_100 array_of_9_logic_vector_100_from_lv(logic [0:8][99:0] i);
    for (int n = 0; n < 9; n=n+1)
      array_of_9_logic_vector_100_from_lv[n] = i[n];
  endfunction
  function automatic array_of_9_logic_vector_100 array_of_9_logic_vector_100_cons(logic [99:0] x,logic [99:0] xs [0:7]);
    array_of_9_logic_vector_100_cons[0] = x;
    array_of_9_logic_vector_100_cons[1:8] = xs;
  endfunction
